...
namespace Petstore.Models {
	...
	public class User
	{
		...
		public class DummyUserExample : OpenApiExample<User>
		{
			...
			{
				Examples.Add(OpenApiExampleResolver.Resolve("Hamza", new User(100, "Hamza", "Gudaal", "hamza69@gmail.com", "420"), NamingStrategy));
				Examples.Add(OpenApiExampleResolver.Resolve("Bruno", new User(101, "Bam", "Gudaal", "hamza69@gmail.com", "420"), NamingStrategy));
				Examples.Add(OpenApiExampleResolver.Resolve("Jumbo", new User(102, "Jumbo", "Gudaal", "hamza69@gmail.com", "420"), NamingStrategy));
		...
		public class DummyUserExamples : OpenApiExample<List<User>>
		{
			public override IOpenApiExample<List<User>> Build(NamingStrategy NamingStrategy = null)
			{
				...
				new User(100,"Hamza","Gudaal","hamza69@gmail.com","420"),
				new User(100, "Hamza", "Gudaal", "hamza69@gmail.com", "420"),
				new User(100, "Hamza", "Gudaal", "hamza69@gmail.com", "420"),
			}));
