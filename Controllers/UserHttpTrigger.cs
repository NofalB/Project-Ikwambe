...
namespace PetStore.Controllers
{
    class UserHttpTrigger
    {
		...
		public async Task<HttpResponseData> GetUserById([HttpTrigger(AuthorizationLevel.Function, "GET", Route = "user/{userId}")] HttpRequestData req, long petId, FunctionContext executionContext)
		{
			// Generate output
			HttpResponseData response = req.CreateResponse(HttpStatusCode.OK);

			User pet = new User(100, "Hamza", "Gudaal", "hamza69@gmail.com", "420");
